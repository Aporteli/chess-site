import { uid } from './ids';
import { newSrsCard, reviewCard } from './srs/srs-algorithm';
...
function chapterFromLines(name: string, eco: string, variation: string, lines: LineMove[], rootComment = ''): Chapter {
                ...
                children: [
                  {
                    san: 'Bc4',
                    nags: [1],
                    comment: 'The Italian Game. Eyes f7, develops the bishop before committing the d-pawn.',
                        ...
                        children: [
                          {
                            ...
                            annotation: 'This is the tabiya. After 4...Nf6 5.d4 is the critical test.',
                            eval: 'white-slight',
                            grade: 'again',
                            dueDays: -2,
                            children: [
                                        ...
                                        children: [
                                          {
                                            san: 'c3',
                                            nags: [1],
                                            comment: "The typical Pianissimo setup: c3, Re1, Nbd2, a4. Don't rush d4.",
                                            grade: 'good',
                                            dueDays: 2,
                                            children: [
                                              {
                                        ...
                                        children: [
                                          {
                                            ...
                                            nags: [1],
                                            comment:
                                              "The point. Open the center while Black's king is still in the middle.",
                                            eval: 'compensation',
                                            grade: 'good',
                                            dueDays: 5,
                                          },
                                    ...
                                    children: [
                                      {
                                        ...
                                        children: [
                                            ...
                                            children: [
                                              {
                                                ...
                                                nags: [1],
                                                comment:
                                                  "The Najdorf ...e5 complex. Occupy d4's retreat and seize space.",
                                                grade: 'again',
                                                dueDays: -2,
                                                children: [
                                                  {
                                          ...
                                          },
                                          {
                                            san: 'Bg5',
                                            comment:
                                              'The classical Najdorf. Poisoned Pawn and Browne systems live here.',
                                            weight: 22,
                                            children: [
                                              {
                                                san: 'e6',
                                                    ...
                                                    children: [
                                                      {
                                                        ...
                                                        nags: [5],
                                                        comment:
                                                          'Poisoned Pawn. Theoretical, but this is a GM-level repertoire.',
                                                        annotation:
                                                            ...
                                                            children: [
                                                              {
                                                                ...
                                                                nags: [1],
                                                                comment:
                                                                  'Take the pawn. The next ten moves are forced homework.',
                                                                eval: 'unclear',
                                                              },
                                                            ],
                                                          },
