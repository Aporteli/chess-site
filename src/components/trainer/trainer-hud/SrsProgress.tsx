      ...
      <div className="flex items-center gap-4">
        <div className="relative shrink-0">
          <svg width="76" height="76" viewBox="0 0 76 76" className="-rotate-90">
            <circle cx="38" cy="38" r={RADIUS} fill="none" stroke="var(--color-bg-elevated)" strokeWidth="7" />
            <circle
              cx="38"
              cy="38"
              r={RADIUS}
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[13.5px] font-medium text-accent-gold-bright">{label}</p>
          <p className="mt-0.5 text-[11.5px] leading-snug text-text-muted">
            Next review <span className="text-text-secondary">{nextReviewLabel(card)}</span>
          </p>
          {node.srs.lapses > 0 && (
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 border-t border-border-subtle pt-3.5">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-[10.5px] text-text-muted">{drill ? 'held this session' : 'session held'}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0">
            <p className="text-[13px] font-semibold leading-tight text-text-primary">{srsState.accuracyPct}%</p>
            <p className="truncate text-[10.5px] text-text-muted">chapter accuracy</p>
          </div>
        </div>
      </div>
    </div>
